...
- importSourceUrl (string; optional): A string defining the base URL where dynamically importable web modules can be found"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, layoutUpdate=Component.UNDEFINED, layoutEvent=Component.UNDEFINED, importSourceUrl=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'layoutUpdate', 'layoutEvent', 'importSourceUrl']
        self._type = 'IdomPlotlyDash'
        self._namespace = 'idom_plotly_dash'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'layoutUpdate', 'layoutEvent', 'importSourceUrl']
